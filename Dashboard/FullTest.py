...
USE_CSI      = True       # True = XC9021 via Picamera2, False = USB webcam
FRAME_W      = 640
FRAME_H      = 480
...
# SPEAKER_PWM = GPIO.PWM(SPEAKER_PIN, SPEAKER_FREQ)
#LED_PWM: GPIO.PWM = None
#SPEAKER_PWM: GPIO.PWM = None
...
def main():
    ...
    while True:
        ...
        if camera_score >= 100:
            ...
            # Play the alert devices
#             speakerThread = threading.Thread(target=playSpeaker, args=(SPEAKER_FREQ, SPEAKER_PIN))
#             speakerThread.start()
#             ledThread = threading.Thread(target=LED_PWM, args=(LED_PIN, LED_FREQ))
#             ledThread.start()
